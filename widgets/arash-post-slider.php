...
class Elementor_Post_Slider_Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'arash_post_slider';
	}

	public function get_title() {
		return esc_html__( 'Post Slider', 'elementor-addon' );
	}
	...
	public function get_keywords() {
		return [ 'postslider', 'slider', 'arash-video' ];
	}

	protected function render() {
        $notShowIds = '35,722,8434,1468,2494,39,1493,7065,2959,1461,2365,2392,2502,2368,2371,2375,2360,2378,2383,2386,2389,1484,2954,10,1478,2230,2285,1481,2210,11,2207,17,1475,37,2213,9,41,1397,13,31,15,19,21,23,25,27,29,1487,8,43,2216,1490,1464,2487,33,1472';
        $optionSlider = array(
            'post_type'=>'page',
            'posts_per_page'=>10,
            'post__not_in' => array($notShowIds)
        );
        $postSlider = new WP_Query($optionSlider);
		?>
        <style>
